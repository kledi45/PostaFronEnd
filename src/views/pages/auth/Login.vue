            ...
            <div
                ...
                <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                    ...
                    <div>
                        ...
                        <Password id="password1" v-model="passwordi" placeholder="Password" :toggleMask="true"
...
export default {
    ...
    methods: {
        async handleLogin() {
            try {
                const response = await ApiService.get("Login/Login", {
                    usernameOrEmail: username.value,
                    password: passwordi.value,
                });
                const apiResponse = new ApiResponse(response.data.statusCode, response.data.result,'');

                cookies.set('authToken', apiResponse.result?.token, '3h');

                this.$router.push({ name: "dashboard" });
            } catch (error) {
                ToastService.showToast("Diqka shkoi keq. Ju lutem kontaktoni administruesin!",3000,"danger");
