<template>
    <Fluid>
        ...
        <DataTable :value="products" v-if="products.length > 0" rowGroupMode="subheader" groupRowsBy="products.client"
            sortMode="single" sortField="products.postman" :sortOrder="1" scrollable scrollHeight="400px"
            ...
            <Column field="canBeOpened" header="Mund të hapet" sortable style="min-width: 16rem">
...
async function advancedSearch() {
    const data = {
        ...
        Receiver: filters.value?.receiver || null,
...
async function getPostmans() {
    const response = await ApiService.get("Users/GetAllPostmans");
...
async function getPostmansWithIdCountry(idCountry) {
